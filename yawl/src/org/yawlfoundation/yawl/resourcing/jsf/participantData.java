...
public class participantData extends AbstractPageBean {
    ...
    public Label getLblPhone() { return lblPhone; }

    public void setLblPhone(Label l) { lblPhone = l; }
...
///baru
    ...
    public void setTxtPhone(TextField tf) { txtPhone = tf; }
    //
    ...
    private void saveChanges(Participant p) {
        ...
        p.setPhone(_sb.stripXMLChars((String) txtPhone.getText()));
