                    ...
                    <ui:form binding="#{participantData.form1}" id="form1">
                        ...
                        <ui:panelLayout binding="#{participantData.pnlUserDetails}"
                            ...
                            <ui:label binding="#{participantData.lblDesc}"
                                      for="txtDesc"
                                      id="lblDesc"
                                      style="left: 12px; top: 116px; position: absolute"
                                      text="Description:"/>

                            <ui:label binding="#{participantData.lblNotes}"
                                      for="txtNotes"
                                      id="lblNotes"
                                      style="left: 12px; top: 200px; position: absolute"
                                      text="Notes:"/>
                                      <!-- baru -->
                            <ui:label binding="#{participantData.lblPhone}"
                                      for="txtPhone"
                                      id="lblPhone"
                                      style="left: 12px; top: 270px; position: absolute"
                                      text="Phone:"/>
                            ...
                            <ui:textArea binding="#{participantData.txtDesc}"
                                         id="txtDesc"
                                         style="left: 100px; top: 116px; width: 285px; height: 60px; position: absolute"/>

                            <ui:textArea binding="#{participantData.txtNotes}"
                                         id="txtNotes"
                                         style="left: 100px; top: 200px; width: 285px; height: 60px; position: absolute"/>
                                         
                            <ui:textField binding="#{participantData.txtPhone}"
                                          id="txtPhone"
                                          onKeyPress="return disableEnterKey(event);"
                                          style="left: 100px; top: 270px; width: 285px; position: absolute"/>
                        </ui:panelLayout>
